												...
												<table width="100%" border="0" cellspacing="0"
													...
													<tr>
														...
														<td><select name="Building_ID" id="Building_ID"
															onChange="javascript:window.location='StudentTHSave.action?BuildingID='+this.value;">
																<s:if test='#{BuildingID}==null'>
																	<option value="SelectedID">请选择</option>
																	<s:iterator value="buildinglist">
																		<option value="${Building_ID}">${Building_Name}</option>
																	</s:iterator>
																</s:if>
																<s:elseif test='#{BuildingID}!=null'>
																	<option value="SelectedID">${BuildingName}</option>
																	<s:iterator value="buildinglist">
																		<option value="${Building_ID}">${Building_Name}</option>
																	</s:iterator>
																</s:elseif>
