            ...
            <tr>
              ...
              <form name="form1" method="post" action="TBAddSave.action">
                ...
                <table width="100%" border="0" cellspacing="0" cellpadding="0">
                  ...
                  <s:iterator id="aa" value="list" var="user">
                    <tr align="center">
                      <td height="25" align="center"><s:property value="#user.Teacher_Name"/></td>
                      <td><s:property value="#user.Teacher_Sex"/></td>
                      <td><s:property value="#user.Teacher_Tel"/></td>
                      <td align="center"><s:property value="#user.Teacher_Username"/></td>
                      <td align="center"><a href="TBDel.action?Teacher_ID=${user.teacherID}&Building_ID=${Building_ID}" onClick="return confirm('确定要将该管理员从该楼宇移除吗？')">移除</a></td>
                    </tr>
                  </s:iterator>
                </table></td>
            </tr>
