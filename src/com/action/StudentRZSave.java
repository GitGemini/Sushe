...
public class StudentRZSave extends ActionSupport {
	...
	public String execute() throws Exception {
		...
		{
			sbean=new StudentDao().GetAllFirstBean(Student_Username);
...
//		cnbean.setStudent_State("入住");
		...
		System.out.println(sbean.getStudent_State());
//		new StudentDao().Update(cnbean);
		new StudentDao().UpdateState(sbean.getStudent_Username());
